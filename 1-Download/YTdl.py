...
def main():
    ...
    output_dir = positional[0] if len(positional) >= 1 else _cfg["downloaded_dir"]
    duration_limit_minutes = (
        int(positional[1]) if len(positional) >= 2 else _cfg["duration_minutes"]
    )
